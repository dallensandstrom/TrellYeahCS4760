...
namespace TrellYeahCapstone.Data.Migrations
{
    ...
    [Migration("20260723194510_AddEvaluationAndStudentBenefit")]
    partial class AddEvaluationAndStudentBenefit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrellYeahCS4760.Models.Grant", b =>
                {
                    ...
                    b.Property<bool>("AgreementOne")
                        .HasColumnType("bit");

                    b.Property<bool>("AgreementThree")
                        .HasColumnType("bit");

                    b.Property<bool>("AgreementTwo")
                        .HasColumnType("bit");

                    b.Property<decimal?>("AllocatedAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("ApplicationSignature")
                        .IsRequired()
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("DeanApprovalNotes")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("DeptChairApprovalNotes")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<string>("StudentBenefit")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("TrellYeahCapstone.Models.AllocationCriterion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MaxScorePercentage")
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("MinScorePercentage")
                        .HasColumnType("decimal(5,2)");

                    b.HasKey("Id");

                    b.ToTable("AllocationCriteria");
                });
            ...
            modelBuilder.Entity("TrellYeahCapstone.Models.GrantReport", b =>
                {
                    ...
                    b.ToTable("GrantReports");
                });

            modelBuilder.Entity("TrellYeahCapstone.Models.GrantRubricScore", b =>
                {
                    b.Property<int>("GrantRubricScoreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GrantRubricScoreId"));
                    ...
                    b.HasKey("GrantRubricScoreId");

                    b.HasIndex("ReviewerUserId");

                    b.HasIndex("RubricCriterionId");

                    b.HasIndex("GrantId", "RubricCriterionId", "ReviewerUserId")
                        .IsUnique();

                    b.ToTable("GrantRubricScores");
                });
            ...
            modelBuilder.Entity("TrellYeahCapstone.Models.GrantRubricScore", b =>
                {
                    ...
                    b.HasOne("TrellYeahCapstone.Models.ApplicationUser", "Reviewer")
                        .WithMany()
